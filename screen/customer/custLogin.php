<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT Id FROM varbite_custregister WHERE Email = '$myusername' and Password = '$mypassword'";
  ...
  <body style="background-image: url('../../assest/pic2.png');">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top"style="background-color:#FDB936 ;">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin-left:35%;">
              <li class="nav-item">
                <a class="nav-link  active" aria-current="page" href="custLogin.php">CUSTOMER</a>
              </li>
              <li class="nav-item">
     ...
     <center><div class="loginBox">
         <center><h3 style="color: white;font-family: 'ZCOOL XiaoWei', serif; ">New Customer</h3></center>
         ...
         <a class="login31" href="../createAcc.html">Create an Account</a>
