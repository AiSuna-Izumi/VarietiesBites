      ...
      <?php
        ...
        while($row = $result->fetch_assoc()) {
          ...
          <form method='POST'  action='restaurantMain.php'>
            ...
            <input class='dash2 no'style='color:black;' type='submit' value='ORDER'></input></form>
          </div>
          <div class='dash' style='margin-top: 10px;'>
          ...
          <div class='box02'>
           <center><div  class='restPend' >
              <h3 style="color:white; font-size: 40px;
                  font-weight: 900;">ORDER AVAILABLE</h3>
            </div></center>
            <iframe class='theRest1' src="orderPend.php" style='width:100%'>
