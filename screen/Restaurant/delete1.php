      ...
      <?php
        ...
        while($row = $result->fetch_assoc()) {
          ...
          <form method='POST'  action='delete1.php' >
            <input type='hidden' name='Email' value=".$row["Email"].">
            <input class='dash2 no'style='color:black;' type='submit' value='DELETE MENU'></input></form>
          </div>";
          }
        }
          ...
          <div class='box02'>
           <center><div  class='restPend' >
              <h3 style="color:white; font-size: 40px;
                  font-weight: 900;">DELETE MENU</h3>
            </div></center>
            <iframe class='theRest1' src="delete.php" style='width:100%'>
