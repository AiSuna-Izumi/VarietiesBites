<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT Id FROM varbite_restaurant WHERE Email = '$myusername' and Password = '$mypassword'";
      ...
      if($count == 1) {
         ...
         header("location: restaurantMain.php");
      }else {
  ...
  <body style="background-image: url('../../assest/pic2.png');">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top"style="background-color:#FDB936 ;">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin-left:35%;">
              ...
              <li class="nav-item">
                <a class="nav-link  active" href="restLogin.php">RESTAURANT MANAGER</a>
              </li>
            </ul>
          </div>
        </div>
     ...
     <center><div class="loginBox">
         <center><h3 style="color: white;font-family: 'ZCOOL XiaoWei', serif; ">New Restaurant</h3></center>
         <p class="custT">With your account you can...</p>
         <p class="custT"> * Save your favourites for faster ordering</p>
         <p class="custT"> * Speed through checkout with saved delivery address and payment information</p>
         <p class="custT"> * Get exclusive deals, right in your inbox.</p>
         <a class="login31" href="../createAccRest.html">Create an Account</a>
         <center><h3 style="color: white;margin-top:20px;font-family: 'ZCOOL XiaoWei', serif; ">Or Sign In</h3></center>
