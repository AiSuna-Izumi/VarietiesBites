    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top "style="background-color:#FDB936 ; ">
      ...
      <?php
        ...
        while($row = $result->fetch_assoc()) {
          ...
          <input type='hidden' name='Email' value=".$row["Email"].">
            <input class='dash2 no'style='color:black;' type='submit' href='adminRestUpdate.php' value='MENU LIST'></input></form>
          </div>
          <div class='dash' style='margin-top: 10px;'>
          <form method='POST'  action='addMenu1.php'>
            <input type='hidden' name='Email' value=".$row["Email"].">
            <input class='dash2 no'style='' type='submit' value='ADD MENU'></input></form>
          </div>
		<div class='dash' style='margin-top: 10px;'>
          ...
          <div class='box02'>
           <center><div  class='restPend' >
              <h3 style="color:white; font-size: 40px;
                  font-weight: 900;">MENU LIST</h3>
            </div></center>
            <iframe class='theRest' style="flex-direction:row;" src="PHP/orderList.php">
