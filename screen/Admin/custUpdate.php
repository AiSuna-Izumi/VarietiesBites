      ...
      <?php
        ...
        while($row = $result->fetch_assoc()) {
          ...
          <form method='POST'  action='custUpdate.php'>
            <input type='hidden' name='Email' value=".$row["Email"].">
            <input class='dash2 no'style='color:black;' type='submit' value='Customer Update'></input></form>
          </div>
          <div class='dash' style='margin-top: 10px;'>
          ...
          <div class='box02'>
           <center><div  class='restPend'>
              <h3 style="color:white; font-size: 40px;
                  font-weight: 900;">CUSTOMER UPDATE</h3>
            </div></center>
            <iframe class='theRest' src="custPHP/custUpdate.php">
