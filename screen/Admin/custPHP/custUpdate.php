<head>
  ...
  <?php
        ...
        while($row = $result->fetch_assoc()) {
         ...
         <table cellpadding='0' cellspacing='0' border='0'>
         <tr>
            <form method='post' action='custUpdate1.php' method='post' >
            <td style='width:10px;' ><input type='hidden'  name='id' value=".$row["Id"]."><center>".$row["Id"]."</center></td>
            <td ><center><input class='edit' name='name' value=".$row["Name"]."></center></td>
            <td ><center><input class='edit' name='Email' value=".$row["Email"]."></center></td>
            <td ><center><input class='edit' name='phone' value=".$row["PhoneNo"]."></center></td>
