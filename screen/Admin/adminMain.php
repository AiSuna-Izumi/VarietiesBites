      ...
      <?php
        ...
        while($row = $result->fetch_assoc()) {
          ...
          <input type='hidden' name='Email' value=".$row["Email"].">
            <input class='dash2 no'style='color:black;' type='submit' href='adminRestUpdate.php' value='Restaurant Pending'></input></form>
          </div>
          ...
          <input type='hidden' name='Email' value=".$row["Email"].">
            <input class='dash2 no' style='' type='submit' href='' value='Customer List'></input></form>
          </div>
          <div class='dash' style='margin-top: 10px;'>
          ...
          <div class='box02'>
           <center><div  class='restPend'>
              <h3 style="color:white; font-size: 40px;
                  font-weight: 900;">RESTAURANT PENDING</h3>
            </div></center>
            <iframe class='theRest' src="PHP/listRestPending.php">
