    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top "style="background-color:#FDB936 ; ">
      ...
      <?php
        ...
        while($row = $result->fetch_assoc()) {
          ...
          <input type='hidden' name='Email' value=".$row["Email"].">
            <input class='dash2 no' style='' type='submit' href='custMain.php' value='Customer List'></input></form>
          </div>
          <div class='dash' style='margin-top: 10px;'>
          ...
          <form method='POST'  action='custRemove.php'>
            <input type='hidden' name='Email' value=".$row["Email"].">
            <input class='dash2 no'style='color:black;' type='submit' value='Customer Remove'></input></form>
          </div> ";
          }
        }
          ...
          <div class='box02'>
           <center><div  class='restPend'>
              <h3 style="color:white; font-size: 40px;
                  font-weight: 900;">CUSTOMER REMOVE</h3>
            </div></center>
            <iframe class='theRest' src="custPHP/custRemove.php">
